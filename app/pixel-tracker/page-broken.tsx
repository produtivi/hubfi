...
import { Search, Plus, Filter, Activity, Eye, EyeOff, MoreVertical, Copy, Trash2, Edit2, X, TestTube, FileText, LayoutDashboard, Shield, Zap, ShoppingCart, ExternalLink } from 'lucide-react'
...
export default function PixelTracker() {
          ...
          try {
               ...
               if (result.success) {
                    ...
                    const transformedPixels = result.data.map((pixel: any) => ({
                         ...
                         lastConversion: pixel.conversions > 0 ? 'Recente' : 'Nunca',
                         status: pixel.status,
     ...
     const handleCopyPixelCode = async (pixelId: string) => {
          try {
               ...
               if (result.success) {
                    ...
                    alert('Erro ao obter código do pixel')
               }
          } catch (err) {
     ...
     // Callback quando pixel for criado
     const handlePixelCreated = (newPixel: any) => {
                                        ...
                                        <div className="flex-1 ">
                                             ...
                                             <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                                  ...
                                                  <div>
                                                       ...
                                                       <p className="text-body font-semibold text-success">{pixel.conversions}</p>
                                                  </div>
                                                  <div>
