    ...
    return (
        <AriaGroup
            ...
            className={({ isFocusWithin, isDisabled, isInvalid }) =>
                cx(
                    "relative flex w-full flex-row place-content-center place-items-center rounded-md bg-background shadow-xs ring-1 ring-border transition-shadow duration-100 ease-linear ring-inset",

                    isFocusWithin && !isDisabled && "ring-2 ring-primary",

                    // Disabled state styles
                    isDisabled && "cursor-not-allowed bg-accent ring-border",
                    "group-disabled:cursor-not-allowed group-disabled:bg-accent group-disabled:ring-border",

                    // Invalid state styles
                    isInvalid && "ring-destructive/50",
        ...
        >
            ...
            <AriaInput
                ...
                className={cx(
                    "m-0 w-full bg-transparent text-md text-foreground ring-0 outline-hidden placeholder:text-muted-foreground autofill:rounded-md autofill:text-foreground",
